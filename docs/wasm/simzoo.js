...
export class Conway {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(Conway.prototype);
        obj.__wbg_ptr = ptr;
        ConwayFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        ConwayFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_conway_free(ptr, 0);
    }
    /**
     ...
     */
    get_width() {
        const ret = wasm.conway_get_width(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('simzoo_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
